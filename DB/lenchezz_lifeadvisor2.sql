...
--
-- База данных: `lenchezz_lifeadvisor2`
--
...
INSERT INTO `contact` (`request_ID`, `Name`, `Category`, `Question`, `Answer`) VALUES
(1, 'Helen', 'Home', 'jdfhfgplghjidfnm', 'sdrftgyjuiop'),
(2, 'Olena Boitsova', 'Recipes', 'dedsfrgtyuiop[', 'adrftgyuhiopedtfy'),
(3, 'Wendy', 'Finances', 'wsedrt78', 'ghtgujhgfdftgujhi'),
(4, 'Olena Boitsova', 'Home', 'sedrty', 'asdrfyuh'),
(6, 'Katesssssssssssss', 'Recipes', 'sdkencfdruivnhf', 'sdjhkflgv,ujhio'),
(17, 'tjtrjrtjrtjtjdfndndn', 'House', 'dndndndndrndnnr', 'sdjhkflgv,ujhio'),
(18, 'Alexander Volynchikov', 'House', 'Test Message', 'sdjhkflgv,ujhio'),
(19, 'Alexanderrr Volynchikov', 'Recipes', 'Test Message', 'sdjhkflgv,ujhiosdjhkflgv,ujhio'),
(20, 'rrrrr', 'hhhh', 'jjjj', ''),
(21, 'fccfjjcjc', 'kvkvkfkf', 'vkkvhvhlh', ''),
(22, 'tttttttttttttttttt', 'yyyyyyyyyyyyyyy', 'uuuuuuuuuuuu', ''),
(23, '', 'Finances', 'rrrrr', ''),
(24, '', 'Recipes', 'Test Test', ''),
(25, '', 'People', 'Testtt', ''),
(26, '', 'House', 'bnm', ''),
(27, '', 'House', 'bnm', ''),
(28, '', 'General', 'mnb', ''),
...
(22, 'test', 2, 'posted', '<h1>WOW!</h1>', 1, 'menu', 'Recipes', NULL);
...
(41, 'aaaf21efw@dgd.com', NULL),
(40, 'aaaf21efw', NULL),
(34, 'test@te1st.com', NULL),
(35, 'test@te55555st.com', NULL),
(36, 'daria@gmai.com', NULL),
(37, 'daria@gmai.com', NULL),
(38, 'test@te1st.com', NULL),
(39, 'a@gmail.com', NULL);
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`ID_comment`), ADD KEY `ID_page` (`ID_page`), ADD KEY `ID_page_2` (`ID_page`);
...
ALTER TABLE `forum_comments`
  ADD PRIMARY KEY (`commentID`), ADD KEY `topicID` (`topicID`);

--
-- Индексы таблицы `forum_topics`
--
ALTER TABLE `forum_topics`
  ADD PRIMARY KEY (`topicID`), ADD KEY `categoryID` (`categoryID`);
...
--
ALTER TABLE `page`
  MODIFY `ID_page` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
